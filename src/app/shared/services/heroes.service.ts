...
export class HeroesService {
  private heroes: any = {
    front: [
      new Hero('Captain Vue', 'vue', 100, [
        new Move('V-bind', 'His attacks are syncronized', 15, 20, MoveType.atk),
        new Move(
          'Time travel',
      ...
      new Hero('Reactionaire', 'react', 100, [
        new Move(
          'onHook throw',
      ...
      new Hero('Sir Angular', 'angular', 200, [
        new Move(
          'Operate the banana',
    ...
    back: [
      ...
      new Hero('Pythonista', 'python', 100, [
        new Move(
          'Flask of venom',
  ...
  getHero(stack: string, id: number): Hero {
    let clone: Hero = Object.assign(
      Object.create(this.heroes[stack][id]),
      this.heroes[stack][id]
    );
    return clone;
  }
